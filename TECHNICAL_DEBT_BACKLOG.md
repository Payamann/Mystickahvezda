...
9. **Zavest automatizovane link/schema kontroly**
   ...
   - Stav navic: stary manualni tarot filename audit `check-missing-cards.js` je archivovany, aby se nepletla historicka `*_disku` mapa s aktualnim `audit:tarot-assets`.
