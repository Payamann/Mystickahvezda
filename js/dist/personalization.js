function S(e,t){let n;return function(...i){clearTimeout(n),n=setTimeout(()=>e.apply(this,i),t)}}var E={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function l(e){return String(e).replace(/[&<>"']/g,t=>E[t])}var d="1.0",g="mh_user_prefs",c={STORAGE_KEY:g,STORAGE_VERSION:d,get(){try{let e=JSON.parse(localStorage.getItem(g))||{};return e.version||(e.version=d),e}catch{return{version:d}}},set(e){let n={...this.get(),...e,version:d};localStorage.setItem(g,JSON.stringify(n))},getSign(){return this.get().sign||null},getName(){return this.get().name||null},setSign(e){this.set({sign:e,signSetAt:Date.now()})},setName(e){this.set({name:e})}};window.MH_PERSONALIZATION=c;function p(){return document.cookie.split(";").some(t=>t.trim()==="logged_in=1")?window.Auth?.isLoggedIn?.()??!0:!1}var r={beran:{label:"Beran",emoji:"\u2648",dates:"21. 3. \u2013 19. 4."},byk:{label:"B\xFDk",emoji:"\u2649",dates:"20. 4. \u2013 20. 5."},blizenci:{label:"Bl\xED\u017Eenci",emoji:"\u264A",dates:"21. 5. \u2013 20. 6."},rak:{label:"Rak",emoji:"\u264B",dates:"21. 6. \u2013 22. 7."},lev:{label:"Lev",emoji:"\u264C",dates:"23. 7. \u2013 22. 8."},panna:{label:"Panna",emoji:"\u264D",dates:"23. 8. \u2013 22. 9."},vahy:{label:"V\xE1hy",emoji:"\u264E",dates:"23. 9. \u2013 22. 10."},stir:{label:"\u0160t\xEDr",emoji:"\u264F",dates:"23. 10. \u2013 21. 11."},strelec:{label:"St\u0159elec",emoji:"\u2650",dates:"22. 11. \u2013 21. 12."},kozoroh:{label:"Kozoroh",emoji:"\u2651",dates:"22. 12. \u2013 19. 1."},vodnar:{label:"Vodn\xE1\u0159",emoji:"\u2652",dates:"20. 1. \u2013 18. 2."},ryby:{label:"Ryby",emoji:"\u2653",dates:"19. 2. \u2013 20. 3."}};window.SIGNS_CZ=r;function b(){let e=document.getElementById("personalized-greeting");if(!e)return;if(!p()||!window.Auth?.user){e.classList.remove("personalized-greeting--visible"),e.setAttribute("aria-hidden","true"),e.removeAttribute("href"),e.textContent="";return}let t=c.getSign(),n=c.getName();if(t&&r[t]){let i=r[t],a=new Date().getHours(),s=a<12?"Dobr\xE9 r\xE1no":a<18?"Dobr\xFD den":"Dobr\xFD ve\u010Der",o=n?`, ${l(n)}`:"",_=`${i.emoji}\uFE0E`;e.innerHTML=`
            <span class="greeting-icon" aria-hidden="true">${_}</span>
            <span class="greeting-text">${s}${o}! Tv\u016Fj dne\u0161n\xED v\xFDhled pro ${i.label} \u2192</span>
        `,e.href=`horoskopy.html#${t}`,e.setAttribute("aria-hidden","false"),e.classList.add("personalized-greeting--visible")}else e.classList.remove("personalized-greeting--visible"),e.setAttribute("aria-hidden","true"),e.removeAttribute("href"),e.textContent=""}function m(){if(!p()){document.querySelectorAll(".zodiac-card").forEach(n=>{n.classList.remove("zodiac-card--highlighted"),n.querySelector(".zodiac-card__badge")?.remove()});return}let e=c.getSign();if(!e)return;document.querySelectorAll(".zodiac-card").forEach(n=>{let i=n.getAttribute("href"),a=i?i.substring(1):null,s=n.querySelector(".zodiac-card__badge");if(s&&s.remove(),a===e&&r[a]){n.classList.add("zodiac-card--highlighted");let o=document.createElement("span");o.className="zodiac-card__badge",o.textContent="Tvoje znamen\xED",n.appendChild(o),window.location.hash===`#${e}`&&requestAnimationFrame(()=>{n.scrollIntoView({behavior:"smooth",block:"center"})})}else n.classList.remove("zodiac-card--highlighted")})}var v=S(e=>{c.setSign(e),m(),h()},100);function A(e){let t=c.getSign();if(e.className="sign-picker",t&&r[t]){let n=r[t];e.innerHTML=`
